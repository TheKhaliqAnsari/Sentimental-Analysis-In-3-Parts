...
def load_model():
    ...
    scrappedrev= pd.read_csv('finaletsy_reviews.csv' , index_col=False ,skiprows=[0], names= ["Review"])
...
def create_app_ui():
    ...
    main_layout = html.Div(
                [
                    ...
                    html.H3(id='second_head',children = "SECTION- 3",
                    ...
                    options=[{'label': scrappedrev['Review'][i], 'value': scrappedrev['Review'][i]} for i in range(0,1001)],
                    value = "select",
